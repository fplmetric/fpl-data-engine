...
# =========================================================================
# 📅 DEADLINE & FIXTURES (ZERO GAP & FIXED INDENTATION)
# =========================================================================
...
if gw_name and deadline_iso:
    ...
    # We use textwrap.dedent to strip the indentation that causes the HTML to break
    combined_html = textwrap.dedent(f"""
    <style>
    ...
    <script>
        ...
        if(subEl) {{
            subEl.innerText = new Date("{deadline_iso}").toLocaleDateString(undefined, dateOpts) + " (Local)";
        }}
