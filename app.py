...
def render_deadline_widget():
    ...
    # Combine and Render
    components.html(css + html_struct + js_logic, height=450, scrolling=True)

# Run the widget function
render_deadline_widget()
