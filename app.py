...
# =========================================================================
# 📅 DEADLINE & FIXTURES (ZERO INDENTATION FIX)
# =========================================================================
...
if gw_name and deadline_iso:
    ...
    # HTML must start at the beginning of the line to avoid Markdown Code Blocks
    combined_html = f"""
<style>
...
<div class="content"><div class="match-grid" id="grid"></div></div>
</details>
</div>
